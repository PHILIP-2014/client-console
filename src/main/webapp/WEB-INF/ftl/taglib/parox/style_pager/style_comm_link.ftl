...
[#else]<li><a href="?${params!}&pageNo=1">首页</a></li><li><a href="?${params!}&pageNo=${lp.prePage}">&laquo;</a></li>[#t/]
[/#if]
[#-- 左侧列表 --]
[#list 1..leftoffset as i]
[#if lp.pageNo==i]<li><a href='javascript:;'>${i}</a></li>[#t/]
[#else]<li><a href='?${params!}&pageNo=${i}'>${i}</a></li>[#t/]
[/#if]
[/#list]
[#-- 中间列表 --]
...
[#else]<li><a href='?${params!}&pageNo=${lp.nextPage}'>&raquo;</a></li><li><a href="?${params!}&pageNo=${lp.totalPage}">尾页</a></li>[#t/]
[/#if]
	</ul>[#t/]
</div>[#t/]